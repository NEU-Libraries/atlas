...
# Binary version-history envelope for one Blob. The counterpart to
...
#
# Shared by versions.json (one Blob) and find_many_versions.json (a batch) so
# the two shapes can't drift.
