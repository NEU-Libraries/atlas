...
#
# SMOKE is set here rather than in the spec: SimpleCov reads it as rails_helper
# loads, which is before any example runs. It lifts the whole-suite coverage
# floor, which a handful of examples could never meet.
